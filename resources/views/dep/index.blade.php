...
@php
  ...
  <div class="container-fluid">
    <div class="row-fluid">
      <div class="span12">
      <a href="{{ route('export.exceldep') }}" title="Excel" class="btn thead">Excel <i class="fa fa-file-excel-o" aria-hidden="true" style="font-size:14px"></i></a>
      <a href="{{ url('/pdf/pdf_dep') }}" title="Excel" class="btn thead">PDF <i class="fa fa-file-pdf-o" aria-hidden="true" style="font-size:13.5px"></i></a>
