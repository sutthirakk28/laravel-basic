            ...
            <div class="widget-box">
                ...
                <div class="widget-content nopadding f_th3">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                        <input type="text" placeholder="เบอร์โทรศัพท์" name="phone" id="phone" value="{{$profiles['phone']}}" disabled/>
                        </div>
                    </div> 
                    <div class="control-group">
...
$(document).ready(function(){
    ...
    $('#edit').click(function(event){
        ...
        $("#username, #email, #password, #password_confirmation,#phone").prop('disabled', false);
        console.log(35453);
    });
